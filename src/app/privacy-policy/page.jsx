        ...
        <div className="max-w-3xl mx-auto bg-[rgba(0,0,0,0.5)] p-6 shadow-lg rounded-md">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-justify text-white/60 text-base">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-white/60 text-justify mt-4">
                <span className="text-ui-primary font-bold">1.Personal Information:</span>{" "}
              ...
              <p className="text-white/60 text-justify">
                <span className="text-ui-primary font-bold">2.Event Preferences:</span>{" "}
                We may collect information about your event preferences, such as the
                types of events you&apos;re interested in attending.
              </p>
              <p className="text-white/60 text-justify">
                <span className="text-ui-primary font-bold">3.Usage Information:</span>{" "}
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-white/60 text-justify mt-4">
                <span className="text-ui-primary font-bold">4.To Provide and Improve Our Service:</span>{" "}
              ...
              <p className="text-white/60 text-justify">
                <span className="text-ui-primary font-bold">5.To Communicate With You:</span>{" "}
              ...
              <p className="text-white/60 text-justify">
                <span className="text-ui-primary font-bold">Note:</span> You can
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-white/60 text-justify mt-4">
                <span className="text-ui-primary font-bold">7.With Event Organizers:</span>{" "}
              ...
              <p className="text-white/60 text-justify">
                <span className="text-ui-primary font-bold">8.With Service Providers:</span>{" "}
              ...
              <p className="text-white/60 text-justify">
                <span className="text-ui-primary font-bold">10.Rights of the Participants:</span>{" "}
              ...
              <p className="text-white/60 text-justify">
                <span className="text-ui-primary font-bold">11.Changes to This Privacy Policy:</span>{" "}
