...
import Card from "../app/tech/page"; // Ensure this path is correct
        ...
        >
          <div style={{ marginBottom: "30px" }}>
            ...
            <Card
              ...
              description="Description for technical event."
            />
          </div>
          <div style={{ marginBottom: "30px" }}>
            <h3 style={{ fontSize: "36px", color: "#fff" }}>
            ...
            <Card
              title="Non-technical Card"
              description="Description for non-technical event."
            />
          </div>
        </div>
        {/* Centered Button */}
